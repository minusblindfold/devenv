...
## Workflow
When executing multi-step workflow pipelines (brainstorm→research→plan→design→implement), always continue to the next step automatically without pausing for user confirmation unless explicitly told to stop.
